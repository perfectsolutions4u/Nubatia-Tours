...
import{a as u}from"./chunk-A2T5RRA3.mjs";import{$b as s,Ab as o,Bb as n,Gd as f,La as c,Qa as p,ba as l,db as d,md as m,yb as a,zb as i}from"./chunk-N3D5JB77.mjs";import"./chunk-T55IDOPT.mjs";var h=class r{backgroundImage="../../../assets/new_images/banner-morocco-desert-tours.jpg";bannerTitle="Terms and Conditions";sanitizer=l(f);termsConditions=`
  ...
  `;static \u0275fac=function(e){return new(e||r)};static \u0275cmp=d({type:r,selectors:[["app-terms-conditions"]],decls:12,vars:3,consts:[[3,"title","backgroundImage"],[1,"my-5","pt-5"],[1,"container"],[1,"detailsBox","rounded-4","overflow-hidden"],[1,"headBox","text-center"],[1,"mainBtn","mb-4","text-capitalize"],[1,"fa","fa-location-dot","me-2"],[1,"text-capitalize","text-white","position-relative"],[1,"terms-content",3,"innerHTML"]],template:function(e,t){e&1&&(n(0,"app-banner",0),i(1,"section",1)(2,"div",2)(3,"div",3)(4,"div",4)(5,"button",5),n(6,"i",6),i(7,"span"),s(8,"travel guide"),o()(),i(9,"h2",7),s(10,"Terms and Conditions"),o()(),n(11,"div",8),o()()()),e&2&&(a("title",t.bannerTitle)("backgroundImage",t.backgroundImage),p(11),a("innerHTML",t.sanitizer.bypassSecurityTrustHtml(t.termsConditions),c))},dependencies:[m,u],styles:['.terms-content[_ngcontent-%COMP%]{padding:1.5rem 2rem 2rem;color:#110f0f;line-height:1.6}.terms-content[_ngcontent-%COMP%]     .section-title{font-family:Playfair Display,serif;color:#9f433a;font-weight:700;font-size:1.1rem;margin:1.5rem 0 .5rem}.terms-content[_ngcontent-%COMP%]     .section-title:first-child{margin-top:0}.terms-content[_ngcontent-%COMP%]     .sub-section-title{color:#110f0f;font-weight:700;margin:1rem 0 .4rem}.terms-content[_ngcontent-%COMP%]     p{margin:.4rem 0 .8rem}.terms-content[_ngcontent-%COMP%]     ul{margin:.4rem 0 .8rem;padding-left:1.5rem;list-style-type:disc}.terms-content[_ngcontent-%COMP%]     ul li{margin:.25rem 0;padding-inline:.5rem}.terms-content[_ngcontent-%COMP%]     ul li::marker{content:"*"}']})};export{h as TermsConditions};
