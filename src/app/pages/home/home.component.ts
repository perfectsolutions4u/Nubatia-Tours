...
import { WhyTravelWithUS } from "../../shared/components/why-travel-with-us/why-travel-with-us";
    ...
    this._DataService.getSetting().subscribe({
      next: (res) => {
        if (res.data && Array.isArray(res.data)) {
          ...
          const baseTitle = seoData.meta_title || seoData.og_title || 'Nubatia Tours - Home';
          ...
          this.seoService.updateSeoData(
            ...
            seoData.meta_description ||
              ...
              'Discover amazing tours and travel experiences with Nubatia Tours. Book your dream vacation today.',
          ...
          this.seoService.updateSeoData(
            {
              meta_title: 'Nubatia Tours - Home',
              og_title: 'Nubatia Tours - Home',
            },
            'Nubatia Tours - Home',
            'Discover amazing tours and travel experiences with Nubatia Tours. Book your dream vacation today.',
