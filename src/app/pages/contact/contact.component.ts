...
export class ContactComponent {
  ...
  bannerTitle: string = 'Contact Us';
  backgroundImage = '../../../assets/new_images/banner-morocco-desert-tours.jpg';
  ...
  ngOnInit(): void {
    this._SeoService.updateSeoData(
      {},
      'Nubatia Tours - Contact',
      "Get in touch with Nubatia Tours. Contact us for bookings, inquiries, or travel assistance. We're here to help you plan your perfect trip.",
