...
@Component({
  selector: 'app-root',
  imports: [CommonModule, RouterOutlet, NavComponent, FooterComponent, NgxSpinnerModule, WhatsappIconComponent, WhyTravelWithUS],
  templateUrl: './app.html',
  styleUrl: './app.scss',
})
export class App {
  protected readonly title = signal('Nubatia Tours');
